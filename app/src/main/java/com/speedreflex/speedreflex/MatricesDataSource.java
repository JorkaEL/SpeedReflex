...
public class MatricesDataSource {
    ...
    private String[] allColMatrice = { MySQLiteMatrice.COLUMN_ID,
            MySQLiteMatrice.COLUMN_DIF, MySQLiteMatrice.COLUMN_SPEUDO,
            MySQLiteMatrice.COLUMN_SCORE};
    ...
    public void addData(String difficulter,String pseudo, String score) {
        ...
        String sql = "INSERT INTO " + dbMatrice.TABLE + " (" + allColMatrice[1]
                ...
                + ") VALUES (?,?,?)";
        database.execSQL(sql, new String[] { difficulter,pseudo,score });
    ...
    private MatriceData cursorToData(Cursor cursor) {
        ...
        comment.setDifficulter(cursor.getString(1));
        comment.setPseudo(cursor.getString(2));
        comment.setScore(cursor.getString(3));
        return comment;
    }
}
